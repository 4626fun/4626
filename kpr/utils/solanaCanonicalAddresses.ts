/** Canonical mainnet addresses for Solana keeper workflows (v1.18.0 release target). */

import type { Address } from 'viem';

export const CANONICAL_SOLANA_BRIDGE_ADAPTER =
  '0x9A61814082A26192DD9Cb201b44058506685Be60' as const;
...
const DEPRECATED_SOLANA_BRIDGE_ADAPTERS = new Set([
  ...
  '0x8e99bb0270bbdf2d64ff6854509cd2410a28fbae',
]);
