# KPR Template Mapping (Locked Adaptation Boundaries)
...
## Runtime constraints (TypeScript in KPR)

- TS workflows run in QuickJS compiled to WASM.
- Do not use Node built-ins in KPR runtime code paths (`node:crypto`, `node:http`, `stream`, AWS SDK).
...
This runtime-template mapping section is retired as part of KPR runtime lane sunset.
