...
- `pnpm -C frontend guard:registry4626-naming` — blocks `4626Registry` / `CreatorRegistry*` / `CreatorLotteryManager` / `CreatorVRFConsumer*` drift; canonical suffix forms are `Registry4626`, `LotteryManager4626`, `VRFConsumer4626` (self-test: `pnpm -C frontend test:guard:registry4626-naming`).
