...
- The waitlist wallet-readiness gate should follow the parent-CSW + Privy embedded-owner model. Do not revive the old `ownerInstallMapping.ts` or sub-account-first waitlist setup path.
