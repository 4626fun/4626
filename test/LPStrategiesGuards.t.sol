...
contract LPStrategiesGuardsTest is Test {
    ...
    function testCreatorLPManagerRevertsWhenNotConfigured() public {
        CreatorLPManager strat = new CreatorLPManager(address(creator), address(paired), address(this), address(this));
    ...
    function testFullRangeRequiresConfig() public {
        FullRangeStrategy strat = new FullRangeStrategy(address(creator), address(paired), address(this), address(this));
