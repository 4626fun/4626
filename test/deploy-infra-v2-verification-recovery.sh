...
Submitting verification for [contracts/shared/deploy/batchers/DeploymentBatcher.sol:DeploymentBatcher] 0x2000000000000000000000000000000000000003.
...
rg '^DEPLOYMENT_BATCHER=0x2000000000000000000000000000000000000003$' "$HANDOFF_ENV_PATH" >/dev/null
rg '^DEPLOYMENT_BATCHER_AUTO_HANDOFF=0x2000000000000000000000000000000000000003$' "$HANDOFF_ENV_PATH" >/dev/null
