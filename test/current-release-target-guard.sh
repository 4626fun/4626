...
phase1_module="0xf3b20557ef8173510693A13EF71F884DB835E8c0"
phase2_module="0x67FD8A34E5b26F875a9513DFf37521A1ca92d80f"
phase3_helper="0x3c89e20AbccE3d8F6344AFf6c63c82F5619EFFCB"
...
rg -F 'Current Live Infrastructure (`v1.11.2-pipe-a` protocol contract release target)' "$ADDRESSES_DOC" >/dev/null
...
rg -F 'Scope: current live Base infra addresses plus the canonical `v1.11.2-pipe-a` protocol contract release target' "$INVENTORY_DOC" >/dev/null
