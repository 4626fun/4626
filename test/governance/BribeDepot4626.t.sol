...
import "@4626/shared/governance/factories/BribesFactory4626.sol";
...
contract BribeDepot4626Test is Test {
    ...
    function setUp() public {
        ...
        factory = new BribesFactory4626(address(voting), owner);
        depot = BribeDepot4626(factory.createBribeDepot4626(vault1));
        assertEq(depot.owner(), owner);
    ...
    function testExpiringLockCannotVoteOrClaimBribes() public {
        ...
        vm.prank(alice);
        vm.expectRevert(BribeDepot4626.NoUserVotes.selector);
    ...
    function testClaimBribe_RevertsIfEpochNotEnded() public {
        ...
        vm.prank(alice);
        vm.expectRevert(BribeDepot4626.EpochNotEnded.selector);
        depot.claim(0, address(bribeToken));
    }
    ...
    function testRolloverExpiredEpoch_AfterGrace_MovesRemainder() public {
        ...
        // M-13: leftover rollover is owner-only (depotOwner from factory ctor, not factory).
        vm.prank(owner);
        ...
        vm.prank(alice);
        vm.expectRevert(BribeDepot4626.EpochClosed.selector);
        depot.claim(0, address(bribeToken));
    }
