# Lottery / VRF operations

Tier 2 archive. Load for Chainlink VRF 2.5 hub, LayerZero integrator, and LotteryManager4626 ops.

Also: `docs/primitives/game-loop/lottery.md`. Rule: `.cursor/rules/contracts-scope.mdc` (lottery paths).
