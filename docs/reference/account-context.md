...
The canonical 4626 account identity is the user's verified email. This document is only about signer, CSW, and active-account behavior after auth. See [Account Auth Invariants](https://github.com/wenakita/4626/blob/main/frontend/docs/account-auth-invariants.md).
