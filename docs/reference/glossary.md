...
Public names used across docs and the app, with internal or onchain identifiers where they differ. Launch steps: [Launch a vault](/guides) · [Launch checklist](/guides/launch-checklist).

## Quick definitions

**New vault launch** *(greenfield)*  
A brand-new vault on the **current** release (**v1.19.1 stack · v1.19.2 epoch**) — not a patch or migration of an older vault (e.g. AKITA).
...
| **New vault launch** | *Greenfield* | New deploy on current release (v1.19.1 stack · v1.19.2 epoch), not legacy vaults |
...
**Legacy vault** — Deployed on an older batcher/version (e.g. AKITA); may differ from the v1.19.1 stack (v1.19.2 epoch) new-vault path.
