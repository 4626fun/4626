...
| **4** | Low-Med (~70) | `processSwapLottery` keeps `msg.value` on early-return paths | **Open** — refund or pull-payment |
| **5** | Low | `VRFConsumer4626` missing `_payNative` ≥ override (exact fee only) | **Open** — relayer UX |
