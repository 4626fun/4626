...
| ODA v2 **427** CreatorOVault | **Complete + partial patch** — [427-TRIAGE.md](./oda-reports/427-TRIAGE.md) (F2 queue / F4 withdraw; F1 needs bond/cap) |
...
| ODA v2 **433** ve4626 | **Complete + patched** — [433-TRIAGE.md](./oda-reports/433-TRIAGE.md) (F1–F3; F4/F6 open) |
...
| # | Review | How | Why |
|---|--------|-----|-----|
| 1 | ~~Implement ODA 426 #1–#2~~ **done** (+ #4/#5 done; #3/#6 open) | LM try/catch + forwarder auth/replay | Correct-scope High/Medium on live lottery path |
...
| 6b | ~~**433-F1**~~ **done** (+ 424-L4 / 428-F4/F5 / 423-M05–M07) | Vote escrow + gauge timers + ShareOFT one-shot | Remaining: 433-F4/F6, 427 valuation gate, 426-F3 |
