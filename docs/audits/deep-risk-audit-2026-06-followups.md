...
Date: 2026-06-27
Companion to: `deep-risk-audit-2026-06.md`
Mode: audit-only — no product/code fixes applied. This file tracks actionable items for post-audit remediation owners.
Canonical finalization note: followups below are tiered from the merged, deduplicated, severity-normalized canonical report. No remediation has been applied in this pass.
...
- **Owner**: docs
- **Action**: Update 4 stale paths in `docs/_internal/4626-connection-methods.md` (§5, §9, §13), 5 stale paths in `docs/_internal/operations/operations/messaging/telegram-canonical-link-preservation.md`, and remove/replace the stale `WaitlistSetupWorkspace.tsx` reference in `frontend/docs/waitlist-accounts-architecture.md:65`.
