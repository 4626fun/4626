...
- `CreatorRegistry` → `Registry4626` (`contracts/core/4626Registry.sol`)
- `CreatorLotteryManager` → `LotteryManager4626` (`contracts/lottery/4626LotteryManager.sol`)
- `CreatorVRFConsumerV2_5` → `VRFConsumer4626` (`contracts/lottery/4626VRFConsumer.sol`)
