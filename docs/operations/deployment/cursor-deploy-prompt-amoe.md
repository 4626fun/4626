...
> **Rev 5 note:** v1.10.0 supersedes the v1.9.x rollout in this doc; for the
> redeploy itself follow `cursor-deploy-prompt-v1.10.0.md`. This doc continues
> to govern the §0 → §3.0.5 AMOE rollout AFTER v1.10.0 broadcasts.

Use this prompt only after the v1.10.0 Base mainnet redeploy has completed and
the new addresses are recorded in
`docs/operations/deployment/releases/v1.10.0-mainnet.md`.
...
- v1.10.0 broadcast complete.
- v1.10.0 addresses recorded in the release packet.
...
or replacement-router addresses for the fresh v1.10.0 manager/router/verifier.
