...
Defined in: [src/lib/uniswap/hooks.ts:15](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L15)
...
Defined in: [src/lib/uniswap/hooks.ts:23](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L23)
...
Defined in: [src/lib/uniswap/hooks.ts:20](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L20)

##### pool?

> `optional` **pool**: [`PoolTokenComposition`](#pooltokencomposition) \| `null`

Defined in: [src/lib/uniswap/hooks.ts:33](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L33)

##### poolId

> **poolId**: `string` \| `null`

Defined in: [src/lib/uniswap/hooks.ts:18](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L18)

##### priceChangePercent

> **priceChangePercent**: `number`

Defined in: [src/lib/uniswap/hooks.ts:22](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L22)

##### timeframe

> **timeframe**: `string`

Defined in: [src/lib/uniswap/hooks.ts:17](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L17)

##### tokenAddress

> **tokenAddress**: `string`

Defined in: [src/lib/uniswap/hooks.ts:16](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L16)

##### tvlUSD

> **tvlUSD**: `number`

Defined in: [src/lib/uniswap/hooks.ts:21](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L21)

##### volumeUSD

> **volumeUSD**: `number`

Defined in: [src/lib/uniswap/hooks.ts:19](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L19)
...
Defined in: [src/lib/uniswap/hooks.ts:146](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L146)
...
Defined in: [src/lib/uniswap/hooks.ts:165](https://github.com/wenakita/4626/blob/main/frontend/src/lib/uniswap/hooks.ts#L165)
