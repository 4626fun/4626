...
[4626-web](../../../index.md) / src/features/accountSetup/AccountsManagementPanel

# src/features/accountSetup/AccountsManagementPanel

## Functions

### AccountsManagementPanel()

> **AccountsManagementPanel**(`props`): `Element` \| `null`

Defined in: [src/features/accountSetup/AccountsManagementPanel.tsx:57](https://github.com/wenakita/4626/blob/main/frontend/src/features/accountSetup/AccountsManagementPanel.tsx#L57)
