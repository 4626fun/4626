...
### ve4626GaugeVoting
ve4626GaugeVoting for ve(3,3) vault probability direction
...
### _timelockArmed
Once true, the legacy `setBoostManager` / `setve4626GaugeVoting`
...
### getTokenLotteryStats

Get lottery stats for a specific creator coin


```solidity
function getTokenLotteryStats(address creatorCoin)
    external
    view
