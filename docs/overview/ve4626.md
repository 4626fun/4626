...
**Optional — after trading is live.** Lock **■4626** to create decaying **ve■4626** power. Assign it to **ve33** (voting) or **veLottery** (personal lottery boost) — or split between both. New vault launches do not require this.
...
Prev: [Fees, auction, and lottery](/overview/how-it-works) · Next: [Solana share bridge](/overview/solana-share-mesh)
