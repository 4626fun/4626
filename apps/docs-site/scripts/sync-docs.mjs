...
const SOURCES = {
  manual: {
    ...
    exclude: [
      ...
      'base-mcp-mvp-implementation-plan.md',
      'zkmetal-deeper-integration.md',
      'sub-accounts-baseapp-design.md',
      'architecture-b-design.md',
      'arch-b-sub-account-design-addendum.md',
