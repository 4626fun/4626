    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'contracts/shared/core/creator-registry',
            'contracts/shared/core/creator-ovault',
            'contracts/shared/core/creator-share-oft',
            'contracts/shared/core/creator-ovault-wrapper',
            'contracts/governance/gauge-controller',
            'contracts/shared/strategies/cca-launch',
