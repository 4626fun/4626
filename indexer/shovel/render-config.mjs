 ...
 *
 * Only product-enabled integrations are defined. Former disabled shells
 * (phase2, share_bridge_solana, burn_stream_*, share_oft_transfers) were
 * removed 2026-07-29 to cut empty public tables — re-add when a consumer exists.
 */
  ...
  integrations: [
    {
      ...
      table: {
        ...
        index: [['creator_token'], ['share_oft'], ['vault'], ['block_num DESC']],
      },
