  ...
  try {
    ...
    for (const row of result.rows as any[]) {
      ...
      try {
        ...
        console.error('[vaults/activeProtected] Registry verification unavailable:', err)
      ...
      if (!registryValidation.ok) {
        console.warn(
          '[vaults/activeProtected] Skipping vault due to registry mismatch',
          {
    ...
    console.error('[vaults/activeProtected] Error:', err)
