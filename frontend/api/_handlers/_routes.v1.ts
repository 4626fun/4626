...
const v1RouteLoaders: ApiRouteLoaders = {
  ...
  'chat/friends': () => import('./v1/chat/_friends.js'),
  ...
  'chat/ethos-sync-hot': () => import('./v1/chat/_ethosSyncHot.js'),
  ...
  'alfaclub/daily-brief': () => import('./v1/alfaclub/_daily-brief.js'),
  'alfaclub/trade-journal': () => import('./v1/alfaclub/_trade-journal.js'),
  ...
  'alfaclub/room-access/recheck': () => import('./v1/alfaclub/_room-access-recheck.js'),
  'alfaclub/creator-coin/status': () => import('./v1/alfaclub/_creator-coin-status.js'),
  'alfaclub/creator-coin/challenge': () => import('./v1/alfaclub/_creator-coin-challenge.js'),
  'alfaclub/creator-coin/verify': () => import('./v1/alfaclub/_creator-coin-verify.js'),
