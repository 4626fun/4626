...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const limiter = checkRateLimit(
    rateLimitKey('v1-spec-json', g.auth?.address?.toLowerCase() ?? 'anon', getClientIp(req)),
  ...
  const spec: OpenApiSpec = {
    ...
    paths: {
      ...
      '/v1/build/charm/setCharmVault': { post: { summary: 'Build CharmStrategy4626 setCharmVault calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/setSwapPool': { post: { summary: 'Build CharmStrategy4626 setSwapPool calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/setUniFactory': { post: { summary: 'Build CharmStrategy4626 setUniFactory calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/setAutoFeeTier': { post: { summary: 'Build CharmStrategy4626 setAutoFeeTier calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/setParameters': { post: { summary: 'Build CharmStrategy4626 setParameters calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/setActive': { post: { summary: 'Build CharmStrategy4626 setActive calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/initializeApprovals': { post: { summary: 'Build CharmStrategy4626 initializeApprovals calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/rebalance': { post: { summary: 'Build CharmStrategy4626 rebalance calldata (owner or vault)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/ownerEmergencyWithdraw': { post: { summary: 'Build CharmStrategy4626 ownerEmergencyWithdraw calldata (owner)', responses: { '200': { description: 'OK' } } } },
      '/v1/build/charm/ownerEmergencyWithdrawFromCharm': { post: { summary: 'Build CharmStrategy4626 ownerEmergencyWithdrawFromCharm calldata (owner)', responses: { '200': { description: 'OK' } } } },
