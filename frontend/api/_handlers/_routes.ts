...
export const apiRouteLoaders: ApiRouteLoaders = {
  'agent-registration': () => import('./agent/_registration.js'),
  ...
  'wallet/disconnect-external': () => import('./wallet/_disconnect-external.js'),
  ...
  'deploy/v2/ajna/automation/status': () => import('./deploy/v2/ajna/_automationStatus.js'),
  'deploy/v2/ajna/automation/control': () => import('./deploy/v2/ajna/_automationControl.js'),
  ...
  'keeper/tend': () => import('./keeper/_tend.js'),
  ...
  'keeper/cre-strategy-health-ingest': () => import('./keeper/_creStrategyHealthIngest.js'),
  ...
  'keeper/solana/activate-b2-relay': () => import('./keeper/_solanaActivateB2Relay.js'),
  'keeper/solana/authorize-b2-canary': () => import('./keeper/_solanaAuthorizeB2Canary.js'),
  'keeper/solana/lottery-ingest': () => import('./keeper/_solanaLotteryIngest.js'),
  'keeper/solana/lottery-submit': () => import('./keeper/_solanaLotterySubmit.js'),
  'keeper/solana/lottery-confirm': () => import('./keeper/_solanaLotteryConfirm.js'),
  'keeper/solana/lottery-winner-settle': () => import('./keeper/_solanaLotteryWinnerSettle.js'),
  ...
  'robots.txt': () => import('./seo/_robots.js'),
  'sitemap.xml': () => import('./seo/_sitemap.js'),
  'social-preview': () => import('./social/_socialPreviewRoute.js'),
  'social-preview-debug': () => import('./social/_socialPreviewDebug.js'),
  ...
  'admin/control-plane/status': () => import('./admin/control-plane/_status.js'),
