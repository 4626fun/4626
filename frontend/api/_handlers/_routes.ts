...
export const apiRouteLoaders: Record<string, () => Promise<ApiHandlerModule>> = {
  ...
  // v1 build endpoints are intentionally routed to a single fallback handler
  // until their concrete implementations are added.
  'v1/build/auction/submitBid': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/gauge/vote': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/gauge/resetVotes': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ve4626/lock': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ve4626/extend': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ve4626/increase': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ve4626/unlock': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/borrow': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/repay': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/addCollateral': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/removeCollateral': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/setBucketIndex': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/moveToBucket': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/ajna/setIdleBufferBps': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setCharmVault': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setSwapPool': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setZRouter': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setUseZRouter': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setUniFactory': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setAutoFeeTier': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setParameters': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/setActive': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/initializeApprovals': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/rebalance': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/ownerEmergencyWithdraw': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/ownerEmergencyWithdrawFromCharm': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/vault/rebalance': () => import('./v1/_buildNotImplemented.js'),
  'v1/build/charm/vault/setStrategy': () => import('./v1/_buildNotImplemented.js'),
