...
export const apiRouteLoaders: Record<string, () => Promise<ApiHandlerModule>> = {
  ...
  'v1/lottery/amoe/nonce': () => import('./v1/lottery/_amoeNonce.js'),
  'v1/lottery/amoe/credits': () => import('./v1/lottery/_amoeCredits.js'),
  'v1/lottery/amoe/submit': () => import('./v1/lottery/_amoeSubmit.js'),
  'v1/lottery/amoe/twitter-checkin': () => import('./v1/lottery/_amoeTwitterCheckin.js'),
  ...
  'v1/agents/feedback/review': () => import('./v1/agents/feedback/_review.js'),
  ...
  'v1/build/ajna/setMinBucketIndex': () => import('./v1/build/ajna/_setMinBucketIndex.js'),
  ...
  'keepr/vault/automation': () => import('./keepr/vault/_automation.js'),
  ...
  'cre/keeper/solana/reconcile': () => import('./cre/keeper/_solanaReconcile.js'),
  ...
  'auth/handoff/create': () => import('./auth/_handoff-create.js'),
  'auth/handoff/redeem': () => import('./auth/_handoff-redeem.js'),
  ...
  'waitlist/join': () => import('./waitlist/_join.js'),
  'waitlist/bootstrap': () => import('./waitlist/_bootstrap.js'),
  ...
  'zora/link/status': () => import('./zora/link/_status.js'),
  'zora/metrics': () => import('./zora/_metrics.js'),
  'zora/refresh': () => import('./zora/_refresh.js'),
