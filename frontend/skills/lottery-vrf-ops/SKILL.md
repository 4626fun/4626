...
- Hub (Base): `contracts/lottery/vrf/CreatorVRFConsumerV2_5.sol`
...
- Spoke (remote chains): `contracts/lottery/vrf/ChainlinkVRFIntegratorV2_5.sol`
  - Forwards "request randomness" to the hub
  - Receives randomness from hub and calls back the local requester
- Lottery manager (per chain): `contracts/lottery/CreatorLotteryManager.sol`
...
- Hub contract: `contracts/lottery/vrf/CreatorVRFConsumerV2_5.sol`
- Spoke contract: `contracts/lottery/vrf/ChainlinkVRFIntegratorV2_5.sol`
- Lottery manager: `contracts/lottery/CreatorLotteryManager.sol`
