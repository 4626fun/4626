...
export const VaultExplainer: React.FC = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl bg-[#030303] border border-glass p-8 md:p-16 transition-all duration-1000 hover:border-brand-primary/40 group min-h-[320px] flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center w-full">
        ...
        <div className="relative h-32 flex items-center justify-center w-full perspective-[1000px]">
            ...
            {/* 1. Technical Standard Layer (ERC-4626 -> 4626.fun) */}
            <div 
            ...
            >
                <div className="flex items-baseline text-5xl md:text-7xl lg:text-8xl tracking-tighter select-none">
                    {/* Prefix */}
                    <span className="font-sans font-semibold text-white transition-colors duration-500">
                        {isExpanded ? '4626' : 'ERC'}
                    </span>
                    ...
                    >
                        ...
                        >
                            {isExpanded ? '.fun' : 'reator'}
                        </span>
                    </div>

                    {/* Suffix */}
                    <span className={`font-doto font-bold text-brand-primary drop-shadow-[0_0_15px_rgba(0,82,255,0.4)] transition-all duration-500 ${isExpanded ? 'opacity-0 scale-0 w-0' : 'opacity-100 scale-100'}`}>
                        4626
                    </span>
                </div>
            </div>
