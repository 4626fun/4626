    ...
    <div className="relative pb-[calc(env(safe-area-inset-bottom)+9rem)] md:pb-0">
      ...
      <section className="py-4 sm:py-5">
        <div className="mx-auto max-w-[1400px] px-3 sm:px-6">
          ...
          <div className="grid justify-center gap-5 xl:grid-cols-[minmax(0,430px)_380px]">
            <div className="mx-auto w-full max-w-[430px]">{swapPanel}</div>
            <div className="xl:sticky xl:top-4 xl:self-start xl:transition-transform xl:duration-300">{vaultPanel ?? children ?? null}</div>
          </div>
        </div>
      </section>
    </div>
