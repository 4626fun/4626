export const API_ENDPOINTS = {
  ...
  alfaclub: {
    ...
    creatorCoinStatus: '/api/v1/alfaclub/creator-coin/status',
    creatorCoinChallenge: '/api/v1/alfaclub/creator-coin/challenge',
    creatorCoinVerify: '/api/v1/alfaclub/creator-coin/verify',
