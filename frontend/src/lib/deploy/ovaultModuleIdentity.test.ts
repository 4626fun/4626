...
describe('ovaultModuleIdentity', () => {
  it('uses .v4 as deploy vault fingerprint after v1.19.1 greenfield', () => {
    expect(DEPLOY_CREATOR_OVAULT_MODULE_STORAGE_VERSION).toBe(CREATOR_OVAULT_MODULE_STORAGE_V4)
    expect(CREATOR_OVAULT_MODULE_STORAGE_CURRENT).toBe(CREATOR_OVAULT_MODULE_STORAGE_V4)
    ...
    expect(CREATOR_OVAULT_MODULE_STORAGE_LEGACY_CURRENT).not.toBe(CREATOR_OVAULT_MODULE_STORAGE_V4)
  })
