...
function DeployVaultMain() {
  ...
  const minFirstDepositTokens = useMemo(() => {
    // Deployment flow currently enforces an exact 100M creator-token first deposit.
    ...
    if (requested !== null && requested !== DEFAULT_MIN_FIRST_DEPOSIT_TOKENS) {
      logger.warn('[DeployVault] ignoring minFirstDepositTokens override; enforcing 100M policy', {
