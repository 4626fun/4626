    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1">
          <h1 className="headline text-2xl sm:text-3xl">Vault Allowlist</h1>
          <div className="text-xs text-zinc-600">Approve or deny vault launch requests and manage the deploy allowlist.</div>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-2xl border border-white/10 bg-black/20 overflow-hidden">
        <div className="px-5 py-4 flex items-center justify-between gap-4 border-b border-white/10">
          <div className="text-sm text-zinc-200">Pending launch requests</div>
              ...
              <div key={r.id} className="px-5 py-4 grid grid-cols-1 md:grid-cols-[1.2fr_1fr_1.2fr_auto] gap-3 md:gap-4 items-start">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] text-zinc-600 mt-1">
                    {new Date(r.createdAt).toLocaleString()} · {r.allowlisted ? 'already on deploy allowlist' : 'not on deploy allowlist'}
                  </div>
                </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-black/20 overflow-hidden">
        <div className="px-5 py-4 flex items-center justify-between gap-4 border-b border-white/10">
          <div className="text-sm text-zinc-200">Allowlisted deploy wallets</div>
            ...
            {allowlisted.map((e) => (
              <div key={e.address} className="px-5 py-4 grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1.2fr_auto] gap-3 md:gap-4 items-start">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-sm text-emerald-200 mt-1">Allowlisted</div>
                </div>
