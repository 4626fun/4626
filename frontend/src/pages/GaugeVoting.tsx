...
export default function GaugeVoting() {
  return (
    <div className="min-h-screen bg-black">
      <PageMeta title={META.gaugeVoting.title} description={META.gaugeVoting.description} canonicalPath="/gauge" />
      {/* Hero Section */}
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          >
            ...
            <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
              ...
              jackpot probability to your favorite creator vaults. No purchase is required to enter via AMOE.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="font-mono text-sm bg-zinc-800/50 rounded-lg p-4 overflow-x-auto">
              ...
              <div className="mt-4 text-zinc-400 space-y-2">
                ...
                <div>• <span className="text-zinc-300">AMOE</span> = no-purchase entry at the same base odds as a minimum paid entry</div>
            ...
            <div className="mt-4 p-4 bg-brand-primary/10 border border-brand-primary/30 rounded-lg">
              ...
              <div className="text-xs text-zinc-400 mt-3">
                AMOE entries are no-purchase and use minimum-entry base odds, with normal anti-abuse limits.
              </div>
            </div>
          </motion.div>
        </div>
