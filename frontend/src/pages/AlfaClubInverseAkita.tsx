            ...
            <div className="overflow-hidden rounded-[2rem] bg-zinc-950/80 ring-1 ring-white/[0.1]">
              ...
              <div className="space-y-6 p-6 sm:p-7">
                <div className="flex items-center gap-4">
                  <div className="grid size-16 shrink-0 place-items-center rounded-2xl bg-gradient-to-br from-sky-400/25 to-violet-500/20 ring-1 ring-white/[0.12]">
                    <Bot className="size-8 text-sky-200" aria-hidden />
                  </div>
                  <div>
            ...
            {SURFACES.map((surface) => {
              ...
              return surface.internal ? (
                <Link
                  key={surface.name}
                  to={surface.href}
                  className="group rounded-2xl bg-white/[0.025] p-6 ring-1 ring-white/[0.08] transition hover:bg-white/[0.05] hover:ring-white/[0.14] sm:p-7"
                >
                  {content}
                </Link>
              ) : (
