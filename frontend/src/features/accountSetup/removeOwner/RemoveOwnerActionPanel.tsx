      ...
      <div className="space-y-3">
        <div className="rounded-xl border border-emerald-400/30 bg-emerald-500/10 p-3 text-[11px] text-emerald-100 space-y-2">
          ...
          <p className="text-[10px] text-emerald-100/80">
            {isSelfAuthSession
              ? 'Submit exact request-bound deposit (orderId/requestId + paymentDetails.amount), then require Relay success + owner-slot change before completion.'
          ...
          <div className="space-y-2 rounded-xl border border-white/15 bg-black/30 p-2.5">
            ...
            <div className="flex items-center justify-between text-xs">
              <span>
                {isSelfAuthSession
                  ? 'Step 2. Submit exact request-bound deposit'
          ...
          <div className="mt-3 space-y-3">
            ...
            >
              {submitBlockedByMissingRequiredDeposit
                ...
                : busy
                ? isSelfAuthSession
                  ? 'Submitting exact request-bound deposit…'
