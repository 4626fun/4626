...
describe('VaultFlowScroll', () => {
  ...
  it('beat 2 keeps a depositor anchor and internal vault drop for one continuous handoff', async () => {
    renderVaultFlowScroll()
    await waitFor(() => {
      expect(screen.getByTestId('beat-2-depositor-anchor')).toBeTruthy()
      expect(screen.getByTestId('beat-2-vault-drop')).toBeTruthy()
    })
  })
