...
import {
  ...
  Deploy,
  DeployCoin,
  DeployVault, VaultCurationReport,
  DistributeCcaLaunch,
  ExploreContent,
...
export const APP_PUBLIC_ROUTES: PathRouteDef[] = [
  {
    ...
    children: [
      ...
      { path: 'how-it-works', element: <ArenaHowItWorksPage /> },
      { path: 'backtest', element: <ArenaBacktestPage /> },
      { path: 'positions', element: <Positions /> },
    ],
  },
...
export const APP_ACCEPTED_ROUTES: PathRouteDef[] = [
  ...
  { path: '/vault/:address/report', element: <VaultCurationReport /> },
