    ...
    `${JSON.stringify(
      {
        ...
        auxiliaryAlreadyAligned: result.auxiliaryAlreadyAligned,
        auxiliaryEnsured: result.auxiliaryEnsured,
        configuredAuxiliaryBatcher: result.configuredAuxiliaryBatcher,
        previousAuxiliaryBatcher: result.previousAuxiliaryBatcher,
        auxiliaryBatcher: result.auxiliaryBatcher,
        auxiliaryCreate2AlreadyAuthorized: result.auxiliaryCreate2AlreadyAuthorized,
        auxiliaryCreate2Ensured: result.auxiliaryCreate2Ensured,
      },
      null,
      2,
    )}\n`,
