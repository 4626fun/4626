...
async function main(): Promise<void> {
  ...
  const phase1Module = getAddress(SPLIT_PHASE1_PHASE1_MODULE)
  const phase2Module = getAddress(SPLIT_PHASE1_PHASE2_MODULE)
  const phase3Helper = getAddress(SPLIT_PHASE1_PHASE3_HELPER)
  const shareMeshHelper = getAddress(SPLIT_PHASE1_SHARE_MESH_HELPER)
  const utilsHelper = getAddress(SPLIT_PHASE1_UTILS_HELPER)
