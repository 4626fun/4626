-- Phase 7: reconcile stale unused indexes that remained present in production.
-- Scope: low-risk log/referral/discovery helper indexes already marked unused by advisor.
