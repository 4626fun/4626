...
-- Lookup pattern is always (room_id, sender_address) → all keys.
-- The PK already covers this leftmost prefix; an explicit index on
-- (sender_address) supports the "purge this sender across rooms"
-- audit query above.
