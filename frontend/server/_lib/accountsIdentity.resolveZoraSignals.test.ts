...
vi.mock('./canonicalCswDelegation.js', async () => {
  const actual = await vi.importActual<typeof import('./canonicalCswDelegation')>('./canonicalCswDelegation')
  return {
    ...actual,
