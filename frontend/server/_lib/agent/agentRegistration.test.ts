...
const CANONICAL_AGENT_WALLET = `eip155:8453:${PROTOCOL_CSW_ADDRESS}`
...
const CANONICAL_AGENT_WALLET_EXPLORER = `https://basescan.org/address/${PROTOCOL_CSW_ADDRESS}`
...
describe('buildAgentRegistration', () => {
  ...
  it('stays aligned with the checked-in public registration mirror for agent 2205', () => {
    ...
    delete process.env.PROTOCOL_CSW_ADDRESS
