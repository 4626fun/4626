...
OVAULT_FACTORY="${OVAULT_FACTORY:-0x29AB55092F4009aa3F3603f32b11A6B02e6F0eb5}"
VAULT_ACTIVATION_BATCHER="${VAULT_ACTIVATION_BATCHER:-0x37A9136dcD3e3245E4E992a1302dfEBD3d8673B3}"
LOTTERY_MANAGER="${LOTTERY_MANAGER:-0x0fC6f30adFD9e82097895Bb166536FdFD8EaC97b}"
VRF_CONSUMER="${VRF_CONSUMER:-0x56E2453Bf8Cf2C3FC33E7D18Edc2310297f2a251}"
UNIVERSAL_BYTECODE_STORE="${UNIVERSAL_BYTECODE_STORE:-0x8599CA87b28320158941C59CB3cd9a3f12083530}"
UNIVERSAL_CREATE2_DEPLOYER="${UNIVERSAL_CREATE2_DEPLOYER:-0xdffB25505F5050E15B3602296330Ef352127d1Ef}"
DEPLOYMENT_BATCHER="${DEPLOYMENT_BATCHER:-0x83A9b2481E3e6d3a8fA12F6eB072253AAc518032}"
VAULT_AUXILIARY_DEPLOY_BATCHER="${VAULT_AUXILIARY_DEPLOY_BATCHER:-0x15eE1D03a5556C28E5079E68763F8231ad68dAdD}"
EPOCH="${DEPLOYMENT_EPOCH_TAG:-v1.20.0}"
