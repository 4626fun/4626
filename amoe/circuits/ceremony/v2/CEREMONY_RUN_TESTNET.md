...
> sandbox. Per the project's own `amoe/circuits/CEREMONY.md` ("Mandatory
...
| Manifest reference | `amoe/circuits/ceremony/v2/v2-manifest.md` |
| Ceremony scripts | `amoe/circuits/ceremony/v2/scripts/` |
...
| Field | Value |
|-------|-------|
| Source | `amoe/circuits/amoe_eligibility.circom` @ `8802874f` |
| Constraints | 11,367 |
| Public inputs | 8 |
| Private inputs | 85 |
...
|----------|------|---------|
| Final zkey | `amoe/circuits/build/amoe_v2_final.zkey` | `7f84d907a857a40b2dd580bfa33d2c91aed4dfc0ab21292cd8423cdf2a3d72c2` |
| Verification key | `amoe/circuits/build/verification_key_v2.json` | `852a9055381586ea613e4a6646725cbdecb838533406cdb7b5605a80c057d797` |
| Solidity verifier | `amoe/circuits/build/AmoeGroth16Verifier_v2.sol` | `15d5648e62d1e57899fafea3573bb67bf0a77dcab29a607cb37393d31fd46a36` |
| Per-step transcript | `amoe/circuits/ceremony/v2/ceremony_transcript_v2.txt` | (committed alongside this file) |
