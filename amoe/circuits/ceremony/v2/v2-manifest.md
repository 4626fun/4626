...
| Field | Value |
|-------|-------|
| Source file | `amoe/circuits/amoe_eligibility.circom` |
...
|----------|------|---------|
| `amoe_v2_final.zkey` | `amoe/circuits/build/` | The proving key. Embeds the full ceremony chain. |
| `verification_key_v2.json` | `amoe/circuits/build/` | The verifying key (38 field elements). |
| `AmoeGroth16Verifier_v2.sol` | `amoe/circuits/build/` | The Solidity verifier contract. |
| `ceremony_transcript_v2.txt` | `amoe/circuits/ceremony/v2/` | Per-contribution log + hashes. |
