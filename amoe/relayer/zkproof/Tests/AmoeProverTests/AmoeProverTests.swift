...
final class AmoeProverTests: XCTestCase {
    ...
    func testProveSkippedIfArtifactsMissing() throws {
        ...
        // <repo>/amoe/circuits/build/. CI builds them with circom + snarkjs.
        // Local dev can run `amoe/tools/zk/regen_amoe_fixture.sh` to generate them.
        //
        // `swift test` is invoked from the package root (amoe/relayer/zkproof) by
        // CI (.github/workflows/zkmetal-macos.yml uses
        // `working-directory: fourksixsixtwo/amoe/relayer/zkproof`). Resolve the
        ...
        // <repo>/amoe/relayer/zkproof/Tests/AmoeProverTests/AmoeProverTests.swift
        //   -> <repo>
        let repoRoot = here
            .deletingLastPathComponent()  // AmoeProverTests/
            .deletingLastPathComponent()  // Tests/
            .deletingLastPathComponent()  // zkproof/
            .deletingLastPathComponent()  // amoe/relayer/
            .deletingLastPathComponent()  // <repo>/
        let zkey = repoRoot
            .appendingPathComponent("amoe/circuits/build/amoe_final.zkey")
