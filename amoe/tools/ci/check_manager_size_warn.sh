...
#   Any change touching contracts/lottery/manager/CreatorLotteryManager.sol
...
CONTRACT="contracts/lottery/manager/CreatorLotteryManager.sol:CreatorLotteryManager"
