...
# starting from:
#   * circuits/amoe/amoe_eligibility.circom            (source circuit)
#   * circuits/amoe/build/pot17_hez_final.ptau         (universal SRS)
#
...
#
# Outputs (in circuits/amoe/build/plonk_fresh/):
