-- Control-plane operation tracking for lifecycle mutations.
-- Stores audit trail for provision/maintenance/operator-action/settlement calls.
...
DROP POLICY IF EXISTS control_plane_operations_deny_all ON public.control_plane_operations;
